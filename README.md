...
```bash
curl -sSL https://raw.githubusercontent.com/YOUR_USERNAME/progflow/main/install.sh | sh
```
...
```bash
curl -sSL https://raw.githubusercontent.com/YOUR_USERNAME/progflow/main/uninstall.sh | sh
```
